...
<head>
    ...
    <link rel="stylesheet" href="style/css/fileinput.min.css">

    <script src="style/js/jquery.min.js" type="text/javascript"></script>
    <script src="style/js/fileinput.min.js" type="text/javascript"></script>
    <script src="style/js/zh.js" type="text/javascript"></script>
</head>
<body>
<div class="container my-4">
    ...
    <form enctype="multipart/form-data" action="uploadServlet" method="post">
        <div class="upload-wrap">
            <input type="file" id="File" multiple="multiple" data-min-file-count="1" name="file" accept=".xls,.xlsx,.txt"/>
        </div>
        <script>
            $('#File').fileinput({
                language: 'zh',//语言设置
                uploadUrl: 'http://localhost:8080/centrality_war_exploded/uploadServlet',//上传地址
                ...
                allowedFileExtensions: ['xls', 'xlsx','txt'],//允许接收的文件类型
