    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="betweennessServlet">Betweenness</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div id="table" class="tab-pane fade in active">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th>
                                    <a href="betweennessServlet?sort=0&enlarge=${enlarge}">节点</a>
                                </th>
                                <th>
                                    <a href="betweennessServlet?sort=1&enlarge=${enlarge}">绝对中心度</a>
                                </th>
                                <th>
                                    <a href="betweennessServlet?sort=2&enlarge=${enlarge}">相对中心度</a>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                ...
                <div id="setting" class="tab-pane fade">
                    <form action="betweennessServlet" method="post">
        ...
        tooltip: {
            formatter: function (param) {
                ...
                return "节点名称：" + param.data.name + "<br/>" +
                    "中间中心度：" + param.data.symbolSize/${enlarge};
            }
        },
