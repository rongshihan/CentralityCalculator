    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="degreeServlet">Degree(old)</a></li>
                <li class="active"><a href="degreeServlet">Degree(new)<span class="sr-only">(current)</span></a></li>
                ...
                <div id="table" class="tab-pane fade in active">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th>
                                    <a href="degreeServlet?sort=0">节点</a>
                                </th>
                                <th>
                                    <a href="degreeServlet?sort=1">绝对入度中心度</a>
                                </th>
                                <th>
                                    <a href="degreeServlet?sort=2">相对入度中心度</a>
                                </th>
                                <th>
                                    <a href="degreeServlet?sort=3">绝对出度中心度</a>
                                </th>
                                <th>
                                    <a href="degreeServlet?sort=4">相对出度中心度</a>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
    ...
    var option = {
        ...
        tooltip: {                  // 提示框的配置
            formatter: function (param) {
                ...
                return "节点名称：" + param.data.name + "\n" +
                    "入度中心度：" + param.data.symbolSize/500;//鼠标停留在节点时，显示节点名称
            }
        },
    ...
    var option = {
        ...
        tooltip: {
            formatter: function (param) {
                ...
                return "节点名称：" + param.data.name + "\n" +
                    "出度中心度：" + param.data.symbolSize/500;
            }
        },
