    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="pageRankServlet">PageRank</a></li>
            </ul>
            <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form action="pageRankServlet" method="post">
                    ...
                    <div id="table" class="tab-pane fade in active">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <th>
                                        <a href="pageRankServlet?sort=0&alpha=${alpha}&beta=${beta}&enlarge=${enlarge}">节点</a>
                                    </th>
                                    <th>
                                        <a href="pageRankServlet?sort=1&alpha=${alpha}&beta=${beta}&enlarge=${enlarge}">PageRank中心度</a>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
        ...
        tooltip: {
            formatter: function (param) {
                ...
                return "节点名称：" + param.data.name + "<br/>" +
                    "PageRank中心度：" + param.data.symbolSize /${enlarge};
            }
        },
